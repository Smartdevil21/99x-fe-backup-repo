          ...
          <CurrencyContext.Consumer>
            {({ currency, setCurrency }) => (
              <>
                {plans.map((plan, i) => {
                  let servicePlan =
                    i == 0 ? "Standard" : i == 1 ? "Premium" : "Enterprise";
                        ...
                        <div className="table-top">
                          ...
                          <div className="actual-price">
                            <span class="strikethrough">
                              {currency.symbol}
                              {(currency.usd_multiplier *
                                plan.price[planPeriod].amount) /
                                100 +
                                201}
                            </span>
                          </div>
...
export default function SubscriptionPlans(props) {
  ...
  let [activeCategory, setActiveCategory] = useState(
    initialCategories[activeIndex].id
  );
  let [activePlanKey, setActivePlanKey] = useState(
    initialCategories[activeIndex].key
  );
