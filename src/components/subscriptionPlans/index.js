										...
										<div className="item">
											<div className="subscription-card fluid">
												<div className="table-top">
													<div className="subscription-type">{plan.title}</div>
													...
													<div className="subscription-price">
														<sup style={{ fontSize: "18px" }}>{currency.symbol}</sup>
												...
												<div className="subscription-points">
													<ul>
														{plan.home_features &&
															plan.home_features.map((feature, index) => {
																const boldRegex = /\*(.+)\*/;
																const boldRegexCheck = feature.match(boldRegex);
																if (boldRegexCheck) {
																	feature = feature.replace(
																		boldRegex,
																		`<b style="font-size:inherit">${boldRegexCheck[1]}</b>`
																	);
							...
							<div className="item">
								<div className="subscription-card fluid">
									<div className="table-top">
										...
										<div className="actual-price">
											<span class="strikethrough">
												${plan.price[planPeriod].amount / 100 + 201}
											</span>
										</div>

										<div className="subscription-price">
											<sup style={{ fontSize: "18px" }}>{plan.price[planPeriod].sign}</sup>
											<span className="amount">{plan.price[planPeriod].amount / 100}</span>
											<br />
											<span className="period">
												Per Month
												{/* {planPeriod} */}
		...
		<>
			<div className="mv-30 family-inter main-subscription-plans">
				<div className="container">
					<h2 className="mb-15 font-48 text-center">{props.title || <>Subscription Plans</>}</h2>
					<p className="text-center mb-30 family-inter subtitle">
						{props.subtitle ||
							"Whatever you need, we've got the right plan for everything your business needs."}
					</p>
