          ...
          <div className="fluid d-flex flex-row justify-content-between align-items-center">
            <div className="d-flex flex-row flex-fill align-items-center">
              <img
                src={
                  props.icon ||
                  "https://ik.imagekit.io/99x/Enterpise_xKAaK-MaR.png"
                }
                height="111"
                className=""
              />
              <div className="ph-20">
                ...
                <p className="family-Inter font-18">
                  ...
                  expertise of working with hundreds of organizations across
                  Industries & Geographies. Schedule a consultation with us.
                </p>
              </div>
            </div>
            <div>
              <NavLink
                exact
                to={"/enterprise-plan"}
                className="custom-button featured active flex-fill justify-content-center font-20"
                style={{
                  minWidth: "165px",
