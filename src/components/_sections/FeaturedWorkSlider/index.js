...
export default function FeaturedWorkSlider(props) {
	...
	let [activePortfolioImage, setActivePortfolioImage] = useState(
		"https://ik.imagekit.io/99x/portfolio/01_ef1rtrvG3.png"
	);
	...
	if (props.site == "design") {
		...
		allCategories = [
			{
				...
				items: [
					[
						{
							thumb: "https://ik.imagekit.io/heliverse/fuse-img_sKGay9rgn.webp?",
							full: "https://ik.imagekit.io/heliverse/fuse-img_sKGay9rgn.webp?",
						},
						{
							thumb: "https://ik.imagekit.io/heliverse/onecare_pBggOJEa3.webp",
							full: "https://ik.imagekit.io/heliverse/onecare_pBggOJEa3.webp",
						},
					],
					[
						{
							thumb: "https://ik.imagekit.io/heliverse/gotissue_y30cygvz5.webp",
							full: "https://ik.imagekit.io/heliverse/gotissue_y30cygvz5.webp",
						},
						{
							thumb: "https://ik.imagekit.io/heliverse/huupe-img_a9Ng6hdDg.webp",
							full: "https://ik.imagekit.io/heliverse/huupe-img_a9Ng6hdDg.webp",
						},
					],
					[
						{
							thumb: "https://ik.imagekit.io/heliverse/concelium_mliRERMJv.webp",
							full: "https://ik.imagekit.io/heliverse/concelium_mliRERMJv.webp",
						},

						{
							thumb: "https://ik.imagekit.io/heliverse/otomain_6fFzB8imw.webp",
							full: "https://ik.imagekit.io/heliverse/otomain_6fFzB8imw.webp",
						},
					],

					[
						{
							thumb: "https://ik.imagekit.io/heliverse/onlineyoga_Lz-bbJ3Rn.webp",
							full: "https://ik.imagekit.io/heliverse/onlineyoga_Lz-bbJ3Rn.webp",
						},

						{
							thumb: "https://ik.imagekit.io/heliverse/new_pKbzdUMZu.webp",
							full: "https://ik.imagekit.io/heliverse/new_pKbzdUMZu.webp",
						},
					],

					[
						{
							thumb: "https://ik.imagekit.io/heliverse/insurance_hwEhRQg2C6.webp",
							full: "https://ik.imagekit.io/heliverse/insurance_hwEhRQg2C6.webp",
						},
						{
							thumb: "https://ik.imagekit.io/heliverse/impact_VTpDuO_OSe.webp",
							full: "https://ik.imagekit.io/heliverse/impact_VTpDuO_OSe.webp",
						},
					],

					[
						{
							thumb: "https://ik.imagekit.io/heliverse/hausmann_hWerJEQvz.webp",
							full: "https://ik.imagekit.io/heliverse/hausmann_hWerJEQvz.webp",
						},

						{
							thumb: "https://ik.imagekit.io/heliverse/kickpick_LSnceyWcy.webp",
							full: "https://ik.imagekit.io/heliverse/kickpick_LSnceyWcy.webp",
						},
					],
				],
			},
		...
		return (
			<>
				<div className="featured-work-slider-design mycontainer pb-3vw">
					<h2 className="heading2 pt-3vw pb-3vw">
						<span>Featured Projects</span>
					</h2>
					<div className="work">
						{console.log({ items: allCategories[0].items })}
						<W3Carousel className={`${activeCat == 0 ? "" : "hidden"}`} items={2}>
							{allCategories[0].items.map((item, i) => (
								<div className="item" key={i} onClick={(e) => FocusPortfolio(item)}>
									<img src={item[0].thumb} style={{ padding: "10px", cursor: "pointer" }} />
									<img src={item[1].thumb} style={{ padding: "10px", cursor: "pointer" }} />
								</div>
							))}
						</W3Carousel>
					</div>
	...
	return (
		<>
			<div className="featured-work-slider">
