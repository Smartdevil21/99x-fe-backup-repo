...
import MobileLogo from "../../assets/_design/logo-studio1.png";
...
class Header extends React.Component {
  ...
  render() {
    ...
    const theme = location.pathname === '/web-application-design' ? 'black' : ''
    console.log({theme}); 
    ...
    const getDefaultCurrency = () => {
      return new Promise((resolve, reject) => {
        let PathUrl = `/profile`;
        PathUrl += localStorage.getItem("w3_user")
          ? "?w3_user=" + localStorage.getItem("w3_user")
          : "";
        apiRequest({
          method: "GET",
          url: PathUrl,
          ...
          .then((d) => {
            if (d.success) {
              if (d.data && d.data.currency_multiplier_usd) {
                ...
                if (!Object.is(NaN, parseInt(currency_multiplier_usd)))
                  localStorage.setItem(
                    "user_currency_multiplier",
                    d.data.currency_multiplier_usd
                  );
    ...
    return (
      <>
        <X99Header />
        <header
          className={`fluid relative ${theme}`}
        ...
        >
          <div className="">
            ...
            <div className="fluid d-flex flex-row custom-main-nav-wrapper">
              <NavLink exact to="/" className="mobile-only">
                <img
                  src={
                    theme === "black"
              ...
              >
                <ul>
                  ...
                  <li>
                    <NavLink exact to="/pricing/subscription">
                      All-in-one Subscription
                    </NavLink>
                  </li>
                  <li>
                    <NavLink exact to="/pricing/on-demand">
                      On-Demand Services
                    </NavLink>
                  </li>
                  <li>
                    <NavLink exact to="/our-work">
                      Our Work
                    </NavLink>
                  </li>
                  <li>
                    <NavLink exact to="/all-access-pass">
                      All Access Pass
                    </NavLink>
                  </li>
                </ul>
