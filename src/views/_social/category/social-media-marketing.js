	...
	return (
		<>
			<CategoryHomeBanner
				...
				title={
					<>
						99x will be your <span className="highlight">Social Media Studio</span>
					</>
				}
			...
			<CategoryMainFeatures
				title={
					<>
						<span className="highlight">Social Media Marketing, </span>made simple
					</>
				}
				...
				features={[
					{
						...
						subtitle:
							"Work with your team of Social Media Manager, Graphic Designer & Content Writer. Plan, preview, and schedule your upcoming posts for your Calendar so that you stay on top of your audience's newsfeed.",
						icon: "https://ik.imagekit.io/99x/startup/category/seo/Frame_437_oCZoG66z3K.png",
					},
					{
						title: "Ad Creatives & Copy that Convert",
						subtitle:
							"Social Media Marketing is partly math and art. We'll take care of the both the sides for you. Marketing expertise + compelling Ad Creatives, Graphics & Copy = More engagements  and sales. ",
						icon: "https://ik.imagekit.io/99x/startup/category/seo/ContentWriter_ugEUgqHo22.png",
					},
					{
						title: "Unlimited Requests & Revisions",
						subtitle:
							"Ceate ads for multiple campaigns in multiple adsets to monitor the best performing ones for your business. We will A/B test everything till we maximise the returns on your ad spends on all campaigns ",
				...
				f2={[
					{
						...
						subtitle:
							"Stand out from the noise. Inspire your audience to take action your social channels",
					},
					{
						title: "FB Ads",
					...
					},
					{
						title: "Instagram Ads",
						subtitle:
							"Drive more sales and revenue to your website or app with social media campaigns that sell",
					},
					{
					...
					},
					{
						...
						subtitle:
							"Get more people using your app with solid social media strategy and data driven approach. ",
					},
					{
						title: "+ Twitter & others",
						subtitle:
							"You need something else? Well, whatever your marketing need is, We've got you covered. ",
					},
				]}
			/>

			<CategoryTools src="https://ik.imagekit.io/99x/social/Group_1544_XxlKv9RlF.svg" />

			<CategorySubscriptionPlan
				minHeightKeyFeatures="450px"
				minHeight="570px"
				labelHeight={[180, 550, 190, 166, 632, 300]}
				title={
					<>
