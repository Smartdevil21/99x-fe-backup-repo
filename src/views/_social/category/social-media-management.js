	...
	return (
		<>
			...
			<CategoryMainFeatures
				title={
					<>
						Build & grow your comminity on <span className="highlight">Social Media</span>
					</>
				}
				...
				features={[
					...
					},
					{
						...
						subtitle:
							"Tell your story your way. We will create relevant content for each social network that's speaks your brand language, content that communicates and connects with your industry, and audience.",
						icon: "https://ik.imagekit.io/99x/startup/category/seo/ContentWriter_ugEUgqHo22.png",
					},
					{
						title: "Social Media Posting and Scheduling",
						subtitle:
							"Save time and stay a step ahead; don't fret over the timely posting on Social Media. We got you covered with a pre-defined calendar and schedule and team that manages your social profiles. ",
				...
				f2={[
					{
						...
						subtitle:
							"Queue up thumb-stopping content across your social media channels ahead of time.",
					},
					{
						title: "Content & Copy",
					...
					},
					{
						...
						subtitle:
							"We've collected the data you need. Dig deeper, get insights to grow reach, & engagement.",
					},
				]}
			/>
