	...
	return (
		<>
			<CategoryHomeBanner
				...
				title={
					<>
						Fresh ideas, great designs for your <span className="highlight">business</span>
					</>
				}
			...
			<CategoryTools src="https://ik.imagekit.io/99x/design/_new/Group_1915_nNPjdnS7uUL.png" />

			<CategorySubscriptionPlan
				minHeightKeyFeatures="450px"
				minHeight="570px"
				labelHeight={[180, 550, 190, 156, 563, 300]}
				title={
					<>
						Flexible <span style={{ color: "var(--color-primary)" }}>Graphic Design </span> Plans
						that grow with you
					</>
				}
