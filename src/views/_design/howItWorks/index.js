...
export default class MainLayout extends React.Component {
  render() {
    return (
      <div className="fluid how-it-works-page">
        <section
          style={{ background: "#391763", top: "-30px" }}
        ...
        >
              ...
              <div className="row d-flex flex-row justify-content-center">
                <div className="col-12 col-sm-12 col-md-8 col-lg-9 text-center">
                  <h1 className="h1 weight-700">
                    {" "}
                    Getting great design is now easy
                  </h1>
                  <p className="font-20 weight-500 family-PTsans">
                    <span className="font-20 weight-600">
                      Because we make sure, every piece of work done is nothing
                      less than exceptional. Collaborate instantly, create work
                      that matters fast, and achieve more in just a few clicks.
                    </span>
                  </p>
                </div>
              </div>
          ...
          <section className="fluid">
            <div className="container">
              <img
                src="https://ik.imagekit.io/99x/design/_new/Mask_Group_drUYNOfnQ.png"
                style={{ maxWidth: "100%" }}
              />
            </div>
          </section>
        ...
        <section className="fluid pt-30">
          <SubscriptionPlans
            ...
            subtitle={
              <>
                Whatever you need, we've got the right plan for everything your
                business needs.
              </>
            }
