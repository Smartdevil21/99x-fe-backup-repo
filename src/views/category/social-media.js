	...
	return (
		<>
			<CategoryHomeBanner
				...
				title={
					<>
						99x will be your <span className="highlight">Social Media Agency</span>
					</>
				}
			...
			<CategoryMainFeatures
				title={
					<>
						Build & grow your community on <span>Social Media</span>
					</>
				}
			...
			<CategoryTools src="https://ik.imagekit.io/99x/startup/category/social_media/Group_1544_CsRkxP2aJ.png" />

			<CategorySubscriptionPlan
				minHeightKeyFeatures="420px"
				minHeight="620px"
				labelHeight={[172, 440, 226, 179, 632, 300]}
				title={
					<>
						Flexible <span>Social Media</span> Plans that grow with you
					</>
				}
