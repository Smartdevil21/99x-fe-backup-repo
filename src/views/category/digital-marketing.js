	...
	return (
		<>
			<CategoryHomeBanner
				...
				title={
					<>
						99x will be your <span className="highlight">Digital Marketing Agency</span>
					</>
				}
			...
			<CategoryMainFeatures
				title={
					<>
						Create campaigns that drive <span className="highlight">results</span>
					</>
				}
				...
				features={[
					...
					},
					{
						...
						subtitle:
							"Digital Marketing is Math and Art. We'll take care of the both the sides for you. Marketing expertise + compelling Ad Creatives, Graphics & Copy = More engagements and sales.",
				...
				f2={[
					{
						...
						subtitle:
							"Stand out from the noise. Inspire your audience to take action your online channels",
					},
					{
					...
					},
					{
						title: "Sales",
						subtitle:
							"Drive more sales and revenue to your website or app with digital campaigns that sell",
					},
					{
						title: "Video",
					...
					},
					{
						title: "App Marketing",
						subtitle:
							"Get more people using your app with solid strategy and data driven approach. ",
					},
					{
						title: "+More",
						subtitle:
			...
			<CategoryTools src="https://ik.imagekit.io/99x/startup/category/digital_marketing/Group_1559_pY3Env7-Q.png" />

			<CategorySubscriptionPlan
				minHeight="632px"
				labelHeight={[200, 356, 235, 170, 632, 300]}
				plans={SubscriptionPlanData.digital_marketing}
			/>
