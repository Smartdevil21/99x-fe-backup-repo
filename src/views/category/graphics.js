	...
	return (
		<>
			<CategoryHomeBanner
				...
				title={
					<>
						99x will be your <span className="highlight">Graphic Design Studio</span>
					</>
				}
			...
			<CategoryMainFeatures
				title={
					<>
						Add <span className="highlight">colors</span> to your brand & online presence.
					</>
				}
				...
				features={[
					{
						...
						subtitle:
							"Get all things designed wether its graphics for your Digital Marketing Campaigns, Social Media Posts or Banners and Covers for your social media pages. We've got you covered.",
					...
					},
					{
						...
						subtitle:
							"Wow people with stunning print design, whether it's Standees, banners and hoardings, menus, brochures, etc. Our designers have the experience and expertise to take care of it for you.",
					...
					},
					{
						...
						subtitle:
							"Take your ideas a step above, arm your business with radiant, vibrant and powerful visual design: Decks and presentations, event Posters, Banners, Profile Covers & more.",
			...
			<CategorySubscriptionPlan
				...
				minHeight="500px"
				labelHeight={[200, 474, 190, 175, 503, 300]}
