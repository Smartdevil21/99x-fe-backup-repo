...
export default function DesignAllAccess() {
	...
	let Resources = [
		...
		{
			image:
				"https://ik.imagekit.io/99x/startup/pages/all-access/design/Developers_-_32px_i_-zG47bsO.svg",
			text: "UI Designer",
		},
		{
			...
			features: [
				{
					...
					banners: {
						software:
							"https://ik.imagekit.io/99x/startup/pages/all-access/design/Group_1726_Fme-5uCL5I.png",
					},
					features: [
				...
				},
				{
					...
					banners: {
						software:
							"https://ik.imagekit.io/99x/startup/pages/all-access/design/Group_1727_hyyJ2X_OzD.png",
					},
					features: [
	...
	return (
		<section className="all-access-page design-all-access">
				...
				features={[
					{
						...
						subtitle:
							"No more fretting over finding resources, hiring spends or infrastructure anymore. Save time, money and your efforts for the bigger things, as for designing amazing assets for your biz, we got you covered. ",
						icon: "https://ik.imagekit.io/99x/startup/pages/all-access/design/Vector_PpcwvOPWz.svg",
					},
					{
						title: "Art & Science meet Context",
						subtitle:
							"Deliver seamless and consistent user and brand experiences that your customers expect. Leverage our industry knowledge from 20+ Industries, inspire, communicate & scale your brand value. ",
					...
					},
					{
						...
						subtitle:
							"Everything you need is right here, under one roof - at a single price point. Whether its print media, digital media or wireframes for your apps and websites, We've got all your needs covered. ",
			...
			<AllAccessHighlight
				...
				title={
					<>
						Flexible <span>Design All Access</span> passes
					</>
				}
							...
							<>
								<div className="price-section" id="pricing">
									<div className="price-blocks">
										...
										<div className={`Resources ${currentPlanIndex == 1 ? "section2" : ""}`}>
											...
											<div className={`Price ${currentPlanIndex == 0 ? "hidden" : ""}`}>
												<div className="price-container">
													<div className="price-left">
														<div className="price-main">
															...
															<h2>
																{parseInt(
																	currency.usd_multiplier * pricing[currentPlanIndex].price
																)}
															</h2>
														</div>
														<span>/per month</span>
												...
												<p className="muted">
													Quoted price applies when staying within the plan's maximum marketing
													budget, social media posts, and website user limits. We don't stop
													campaigns if limits are exceeded, but you will be charged for overages.
													Additional charges for add-ons will also apply.
												</p>
											</div>
										</div>
									</div>
									<div className={`Price ${currentPlanIndex == 1 ? "hidden" : ""}`}>
										...
										<p className="muted">
											Quoted price applies when staying within the plan's maximum marketing budget,
											social media posts, and website user limits. We don't stop campaigns if limits
											are exceeded, but you will be charged for overages. Additional charges for
											add-ons will also apply.
										</p>
									</div>
								</div>
