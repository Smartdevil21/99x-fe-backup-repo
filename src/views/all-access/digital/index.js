...
export default function DigitalAllAccess() {
	...
	let Resources = [
		...
		{
			image:
				"https://ik.imagekit.io/99x/startup/pages/all-access/digital/Copywriter_-_32px_XXwqgo8jMI.svg",
			text: "Copywriter",
		},
		{
			image:
				"https://ik.imagekit.io/99x/startup/pages/all-access/digital/VideoEditor_-_32px_yyBM3yf85.svg",
			text: "Video Editor",
		},
	];
	...
	return (
		<section className="all-access-page digital-all-access">
			...
			<AllAccessMainFeatures
				...
				title={
					<>
						Scale your <span className="highlight">Digital Marketing</span> efforts
					</>
				}
				...
				features={[
					{
						...
						subtitle:
							"With us, you wont just get a guy who runs campaigns, you get to work with a team of experts. An experienced Digital Marketer, Graphic Designer & Content Writer for your campaigns.",
			...
			<AllAccessHighlight
				...
				title={
					<>
						Flexible <span>Digital All Access</span> passes
					</>
				}
								...
								{({ currency, setCurrency }) => (
									<div className="Price">
										...
										<button
											onClick={() => {
												SubscribeToService(
													pricing[currentPlanIndex].id,
													pricing[currentPlanIndex].price
												);
											}}
										>
											Subscribe
