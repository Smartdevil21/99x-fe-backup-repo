...
export default function TechAllAccess() {
	...
	let Resources = [
		...
		{
			image:
				"https://ik.imagekit.io/99x/startup/pages/all-access/tech/Developers_-_32px_QOgAqp3hO7.svg",
		...
		{
			image:
				"https://ik.imagekit.io/99x/startup/pages/all-access/tech/Copywriter_-_32px_8mNMkrF4D.svg",
			text: "UX/UI Designer",
		},
	];
			...
			features: [
				{
					...
					banners: {
						software:
							"https://ik.imagekit.io/99x/startup/pages/all-access/tech/Group_1714_JBrRJjmwv_.png",
					},
					category: "SMEs",
					features: [
				...
				{},
				{
					...
					banners: {
						software:
							"https://ik.imagekit.io/99x/startup/pages/all-access/tech/Group_1715_xD2zOYo2c.png",
					},
					category: "SMEs",
					features: [
	...
	return (
		<section className="all-access-page tech-all-access">
				...
				features={[
					{
						...
						subtitle:
							"No more fretting over finding resources, hiring spends or infrastructure anymore. Save time, money and your efforts for the impactful  things, as for building your vision and products, we got you covered.",
					...
					},
					{
						...
						subtitle:
							"Everything you need is right here, under one roof - at a single price point. Right from SEO to building a stronger social media presence to running digital marketing campaigns at scale.",
						icon: "https://ik.imagekit.io/99x/startup/pages/all-access/tech/Group_84_OthU-Z-Dc7.svg",
					},
					{
						title: "Switch between projects at will",
						subtitle:
							"Want us to work on Social Media this week and switch to a SEO next week? and manage social media simultaneously No problem. We've got you covered everywhere.",
			...
			<AllAccessHighlight
				...
				title={
					<>
						Flexible <span>Tech All Access</span> passes
					</>
				}
				...
				<div className="container">
					<div className="price-section">
						...
						<div className="Price" id="pricing">
							...
							<p className="muted">
								Quoted price applies when staying within the plan's maximum marketing budget, social
								media posts, and website user limits. We don't stop campaigns if limits are
								exceeded, but you will be charged for overages. Additional charges for add-ons will
								also apply.
							</p>
						</div>
					</div>
					<div className="price-notice">
						<p>
							Looks like you need more than 50 hours for developing awesome mobile and web apps.
							You'll need our Premium plan.
						</p>
					</div>
				</div>
			</section>
