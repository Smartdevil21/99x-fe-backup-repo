            ...
            <div className="row">
              <div className="col-12 col-sm-12 col-md-6 pv-30 home-page">
                <h1 className="color-blue">
                  Startup Studio,{" "}
                  <span className="typed-h1">
                    <span>On the Cloud</span>
                  </span>
                </h1>
                ...
                >
                  ...
                  >
                    <i class="fa fa-plus" aria-hidden="true"></i> Web & App
                    Development
                  </NavLink>
                  <NavLink
                    exact={true}
                  ...
                  >
                    <i class="fa fa-plus" aria-hidden="true"></i> Digital
                    Marketing
                  </NavLink>
                  <NavLink
                    exact={true}
                  ...
                  <NavLink
                    exact={true}
                    to={"/"}
                    className="custom-button color6"
                  >
              ...
              <div className="col-12 col-sm-12 col-md-6 desktop-only">
                <img
                  src="https://ik.imagekit.io/99x/startup/revised/Homepage_Primary_Banner2x_hJCiDEygm.png"
