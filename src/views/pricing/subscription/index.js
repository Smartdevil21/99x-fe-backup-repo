          ...
          <div className="container">
            <div className="row">
              ...
              <div className="col-12 col-sm-12 col-md-6 hero-text">
                ...
                <h2>Your digtial marketing agency, in the cloud.</h2>
                <p>
                  99x Startup combines the creative, strategy and experienced
                  diversity of our talented global community, experienced
                  in-house strategists, project managers and a super intuitive
                  robust platform to deliver innovative digital marketing
                  solutions.
                </p>
              </div>
            </div>
