	...
	return (
		<>
			<CategoryHomeBanner
				...
				title={
					<>
						99x will be your <span className="highlight">SEO Studio</span>
					</>
				}
			...
			<CategoryMainFeatures
				title={
					<>
						Boost your <span className="highlight">Search Engine Optimization</span> efforts
					</>
				}
				...
				features={[
					{
						...
						subtitle:
							"A team of SEO Specialist, Content Writer & Content Distributor, work for your busines. Formulating the right search strategy, that drives traffic, builds expertise, and authority.",
						icon: "https://ik.imagekit.io/99x/startup/category/seo/Frame_437_oCZoG66z3K.png",
					},
					{
						title: "Content that drives users for more.",
						subtitle:
							"Content drives search. Stay ahead of the competition with engaging articles, blog posts & visuals that caters to your users, business and industry specifically.",
						icon: "https://ik.imagekit.io/99x/startup/category/seo/ContentWriter_ugEUgqHo22.png",
					},
					{
						title: "Content Distribution & Link Building",
						subtitle:
							"Content creation is vital, but so is the distribution of it to reach your users. With our mix of proven search strategies and tactics, set up your website and SERPs for growth consistently.",
				...
				f2={[
					{
						...
						subtitle:
							"Audit, analyze and fix the core search driving factors that help move  up the search ladder.",
					},
					{
					...
					},
					{
						title: "Link Building",
						subtitle:
							"Build authority, get links from high-quality sources and drive relevant traffic to your site.",
					},
					{
						title: "Content Distribution",
						subtitle:
							"Get more traction with Whitehat directory submissions, social bookmarkings & more",
					},
					{
						title: "Tools & Reporting",
						subtitle:
							"We've collected the tools you need. Get optimized and stay ahead with detailed anlytics & reports. ",
					},
					{
						title: "+More",
						subtitle:
							"You need something more? Well, whatever your SEO need is, We've got you covered. ",
					},
				]}
			/>

			<CategoryTools src="https://ik.imagekit.io/99x/startup/category/seo/LogoStack_zK9fCTDfi.png" />

			<CategorySubscriptionPlan
				minHeightKeyFeatures="350px"
				minHeight="570px"
				labelHeight={[180, 400, 250, 118, 632, 300]}
				title={
					<>
						Flexible <span style={{ color: "var(--color-primary)" }}>Social Media Plans</span> that
						grow with you
					</>
				}
