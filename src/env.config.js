...
const environments = {
  ...
  _: {
    ...
    CURRENT_SITE: parseInt(
      allSiteCodes.includes(process.env.REACT_APP_SITE)
    ...
    NETWORK_SITES: {
      STARTUP: {
        ...
        SETTINGS: {
          LOGO_URL:
            "https://ik.imagekit.io/99x/startup/revised/logo/New_99XStartup_Logo_kS41_r-Y_.svg",
          LOGO_URL_WHITE:
            "https://ik.imagekit.io/99x/startup/99xStartup_white_uUGDgdALbr.png",
        },
      },
      CONTENT: {
        CODE: 2,
      ...
      DESIGN: {
        ...
        SETTINGS: {
          LOGO_URL:
            "https://ik.imagekit.io/99x/startup/revised/logo/99xStudio_logo_r2-w_C8gJ.svg",
          LOGO_URL_WHITE:
            "https://ik.imagekit.io/99x/design/_new/99xDesign_XiucZFyrp.png",
        },
      },
      STUDIO: {
        CODE: 4,
      ...
      SEO: {
        ...
        SETTINGS: {
          ...
          LOGO_URL_WHITE:
            "https://ik.imagekit.io/99x/seo/99x_SEO_KfzW1JZdv.png",
        },
      },
      SOCIAL: {
        CODE: 6,
        ...
        SETTINGS: {
          ...
          LOGO_URL_WHITE:
            "https://ik.imagekit.io/99x/social/Logo_KfLcU6HUD.png",
        },
      },
    },
    CDN: {
    ...
    PAYMENTS: {
      STRIPE: {
        ...
        PUBLISHABLE_KEY:
          "pk_live_51H22e7GVvBC62DxnglCojNUE2eSGHiwVFmG1PGTrDMjvIENb6ECyTjLrFrcQMWJwYF0X7wpGLaus8q1i41FRXlGB004fHqa464",
      },
      PAYPAL: {
        TEST_MODE: false,
        //CLIENT_ID:"AQQtZWOhwmNTOcUoxEXi0a3-qCBeGEcmi0JHmfw2eHXp-3-FAsuytDGkyXXPjM2Ft38Z6oE9KyUWVmGK"
        CLIENT_ID:
          "AT_nRKjJStvdIIXgn6LT-8CFnse1Tim6qhtSTJevVR9lnuIda87NcEybkE2eVMPB4QrIN3LBi1C6vBzO",
      },
      RP: {
        ENABLED: true,
